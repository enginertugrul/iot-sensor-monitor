...
public final class PasswordRecoveryCodeDelivery {
    ...
    public PasswordRecoveryCodeDelivery(
            Long userId,
    ...
    public String toString() {
        return "PasswordRecoveryCodeDelivery[userId=" + userId
                + ", recipientEmail=[REDACTED], rawCode=[REDACTED], expiresAt="
                + expiresAt + "]";
    }
